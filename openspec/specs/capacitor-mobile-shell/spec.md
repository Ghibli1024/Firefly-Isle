# capacitor-mobile-shell Specification

## Purpose
Define Firefly-Isle's Capacitor iOS/Android mobile shell baseline: wrap the existing Vite/React production build, preserve Supabase/Edge Function/RLS privacy boundaries, keep native projects reproducible from repository commands, and explicitly defer signing and store release work.
