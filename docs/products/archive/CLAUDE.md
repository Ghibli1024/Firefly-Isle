# archive/
> L2 | 父级: /docs/products/CLAUDE.md

成员清单
CLAUDE.md: 说明历史产品快照目录边界，防止 archived 文档覆盖当前规格与设计入口，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
prd.md: 早期产品问题、用户场景、MVP 边界与未来愿景快照，仅作历史 PRD 证据，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
