...
App.tsx: 路由装配入口，负责 BrowserRouter、ThemeProvider、AuthProvider、PrivacyGate、品牌锁定组合预览页与四类产品页面路由拼接，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
...
lib/: 主题状态、设计系统 token、认证、隐私文案、LLM adapter、信息提取、正式病历导出、Supabase 客户端与通用工具
routes/: 登录页、隐私条款页、临床工作区、档案详情与品牌锁定组合预览页面骨架
