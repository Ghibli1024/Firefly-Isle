...
login-entry-view.tsx: 登录页入口编排层，渲染双主题全屏背景、内页同源 FireflyBrandWordmark、route/stagger 进入节奏、小屏可纵向生长且随文档流/大屏右下固定的工具区、安全状态、CTA 与认证弹层入口，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
