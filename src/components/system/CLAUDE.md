...
sidebar-nav.tsx: V3 响应式侧栏组件，统一 dark/light 的紧凑桌面默认展开、移动端默认收起、独立品牌 mark/标题、边线胶囊三态点击、窄恢复胶囊、左缘渐进拉出、拖拽缩放到隐藏、阈值 icon-only、active 图标与文字同色、统计敬请期待短提示、临床笔记病历图标、主题/语言切换、隐私/匿名与会话出口，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
