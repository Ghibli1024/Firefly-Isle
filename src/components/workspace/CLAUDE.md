...
extraction-composer.tsx: 工作区输入与主操作区，收口文本输入、OCR 文件导入、语音工具、OCR 文本确认、自然语言编辑反馈、错误提示、状态反馈与带旋转 loading icon 的唯一主提取动作，不承载正式导出入口，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
