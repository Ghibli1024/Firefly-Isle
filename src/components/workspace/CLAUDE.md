...
report-preview-frame.tsx: V3 工作区病历预览主表面，内联渲染正式档案入口、按需追问进度提示、含身高体重 BMI 的基本信息网格、由 initialOnset/treatmentLines 投影的真实横向治疗线、临床备注、验证状态与编辑翻出动效，并保留 setReportRef 导出捕获点，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
