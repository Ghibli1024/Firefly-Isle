 ...
 * [OUTPUT]: 对外提供 LlmProviderSettingsPanel 组件，渲染系统 DeepSeek / 自带 provider / custom OpenAI-style 设置入口。
 * [POS]: components/workspace 的 provider 设置区块，被 ExtractionComposer 嵌入，负责 UI 与保存动作但不参与 chat 请求。
