...
record-dossier.tsx: 病例详情主展示层，承载档案版心、概要指标、多行检查证据、按需实验室趋势、桌面独立日期/PFS rail、移动卡内 PFS、无重复卡片标题时间线、证据卡 stagger、页面级字段保存编辑值、导出按钮与不可用态，页头、标题旁线别小字与补充资料行不重复已表达信息，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
