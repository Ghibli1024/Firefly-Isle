    ...
    <div className="min-h-screen bg-[var(--ff-surface-base)] font-['Inter'] text-[var(--ff-text-primary)]">
      ...
      <MainShell className={`${topBarOffsetClass} ${sidebarOffsetClass} min-h-screen p-12`} theme="dark">
        <div className="mx-auto max-w-4xl">
          ...
          <RecordSectionFrame
            badge={{ label: 'In Progress', variant: 'outline' }}
            body={
              <>
                <div className="mb-8">
                  <h3 className="mb-6 font-['Inter_Tight'] text-4xl font-bold text-[var(--ff-text-primary)]">
      ...
      <div className="flex min-h-screen">
        ...
        <MainShell className="mx-auto max-w-6xl flex-grow p-8" theme="light">
          ...
          <RecordSummaryHeader
            ...
            metrics={[
              { label: '年龄', value: '64' },
              { accent: true, label: '血型', value: 'A+' },
              { label: '身高', unit: 'CM', value: '178' },
              { accent: true, label: '体重', unit: 'KG', value: '72' },
            ]}
            recordId={recordId}
            theme="light"
          />
                ...
                body={
                  <div className="grid grid-cols-7 gap-8">
                    <div className="col-span-2 space-y-4">
                      <RecordSideCard
                        body="EGFR 19-del"
                        subtitle="Exon 19 Deletion Detected"
                        theme="light"
                        title="Genetic Data"
                        tone="action"
                      />
                      <RecordSideCard
                        body="奥希替尼 (Osimertinib)"
                        subtitle="80mg qd, Oral"
                        theme="light"
                        title="Protocol"
                      />
                    </div>
