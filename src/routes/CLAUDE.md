...
record-page.tsx: 档案详情复刻实现，对应 /record/:id，单文件承载宽幅响应式档案版心、顶部概要、正式 PDF/PNG 导出入口、demo fallback 禁用态、8 项指标、纵向 01/02/03 时间轴、右侧证据卡与底部审计带，复用可变侧栏、匿名/非匿名会话身份展示与认证出口，[PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
